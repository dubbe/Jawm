...
DUBBE.jawm.app.memory = function(rows, cols, name){
	...
	DUBBE.jawm.wm.window.call(this, "Memory", "memory", 274, 0, "no") ; 
...
DUBBE.jawm.app.memory.prototype = new DUBBE.jawm.wm.window ;

DUBBE.jawm.app.memory.prototype.init = function(){
	this.drawWindow() ;
	this.menuOpt() ;
	this.start();
}

DUBBE.jawm.app.memory.prototype.start = function() {
...
DUBBE.jawm.app.memory.prototype.changeGame = function() {
...
DUBBE.jawm.app.memory.prototype.restart = function() {
...
DUBBE.jawm.app.memory.prototype.showBrick = function(brick, obj) {
	...
	var divBrick = obj.parentNode ;
	var brickImg = obj.childNodes[0];
...
DUBBE.jawm.app.memory.prototype.closeBricks = function() {
...
DUBBE.jawm.app.memory.prototype.generateBrick = function(brick, divBrick) {
...
DUBBE.jawm.app.memory.prototype.updateInfo = function() {
	++this.tries ;
...
DUBBE.jawm.app.memory.prototype.createInfo = function() {

	$("<p>").html("<b>Försök:</b> "+this.tries+"<br/><b>Hittade:</b> "+this.found).appendTo(this.divInfo).addClass("memoryInfoText") ;

}
DUBBE.jawm.app.memory.prototype.updateTime = function(){
...
DUBBE.jawm.app.memory.prototype.generateField = function() {
		
	var divCont = $("<div>").addClass("divCont").appendTo($(this.getContent())) ;
...
DUBBE.jawm.app.memory.prototype.finish = function() {
...
DUBBE.jawm.app.memory.prototype.getHighscore = function(){
	var that = this;
	
	$.ajax({
        url: "JS/jawm/app/memory/highscore.xml",
		cache: false,
...
DUBBE.jawm.app.memory.prototype.drawHighscore = function(data){
...
DUBBE.jawm.app.memory.prototype.writeHighscore = function(){
	var that = this ;
	...
	$.ajax({
		type: "POST",
		url: "JS/jawm/app/memory/writeHighscore.php",
		data: ({
			tries : tries,
			time : time,
...
DUBBE.jawm.app.memory.prototype.menuOpt = function(){
	var that=this ;
	var menuArr = [] ;
